...
td::actor::ActorOwn<Overlays> Overlays::create(std::string db_root, td::actor::ActorId<keyring::Keyring> keyring,
                                               ...
                                               std::string prefix) {
  return td::actor::create_actor<OverlayManager>("overlaymanager", db_root, keyring, adnl, dht, buffer_limits, std::move(prefix));
}
...
OverlayManager::OverlayManager(std::string db_root, td::actor::ActorId<keyring::Keyring> keyring,
                               ...
                               OverlayManagerBufferLimits buffer_limits,
                               std::string prefix)
    : buffer_limits_(buffer_limits), db_root_(db_root), keyring_(keyring), adnl_(adnl), dht_node_(dht), prefix_(prefix) {
}
