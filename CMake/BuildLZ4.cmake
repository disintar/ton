...
if (LZ4_FOUND AND EXISTS "${LZ4_LIBRARY}")
  if (NOT LZ4_LIBRARY AND LZ4_LIBRARIES)
    list(GET LZ4_LIBRARIES 0 LZ4_LIBRARY)
  endif()
  if (NOT LZ4_INCLUDE_DIR AND LZ4_INCLUDE_DIRS)
    list(GET LZ4_INCLUDE_DIRS 0 LZ4_INCLUDE_DIR)
  endif()
  if (LZ4_LIBRARY AND EXISTS "${LZ4_LIBRARY}" AND LZ4_INCLUDE_DIR AND EXISTS "${LZ4_INCLUDE_DIR}")
    ...
    set(LZ4_INCLUDE_DIR ${LZ4_INCLUDE_DIR} CACHE PATH "LZ4 include dir" FORCE)
    set(LZ4_INCLUDE_DIRS ${LZ4_INCLUDE_DIR} CACHE PATH "LZ4 include dir" FORCE)
    ...
    message(STATUS "Using preconfigured lz4: ${LZ4_LIBRARY}")
    return()
  endif()
endif()
