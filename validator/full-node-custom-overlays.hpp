...
class FullNodeCustomOverlay : public td::actor::Actor {
 public:
  ...
  void process_block_broadcast(PublicKeyHash src, ton_api::tonNode_Broadcast &query, double received_at = 0.0);
  ...
  void process_block_broadcast_with_state(PublicKeyHash src, ton_api::tonNode_blockBroadcastCompressedV2 query,
                                          td::Ref<ShardState> state, BlockPropagationTrace trace);
