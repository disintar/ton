...
static td::Result<td::Ref<vm::Cell>> generate_block_proof_root_for_top_descr(BlockIdExt id,
...
static td::actor::Task<Ref<vm::Cell>> get_proof_root(BlockHandle handle, td::Timestamp timeout,
  ...
  auto new_proof_root = CO_TRY(generate_block_proof_root_for_top_descr(block->block_id(), block->root_cell()));
