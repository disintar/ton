...
namespace ton {
    ...
    namespace validator {
        ...
        void LiteQuery::fetch_account_state(
                ...
                promise) {
          td::actor::create_actor<LiteQuery>("litequery", wc, acc_addr, std::move(manager),
        ...
        void LiteQuery::abort_query_ext(td::Status reason, bool unknown) {
          ...
          if (query_obj_ != nullptr) {
            LOG(INFO) << "aborted liteserver query: " << reason.to_string()
                      << " query: " << lite_query_name_by_id(query_obj_->get_id()) << " QUERY: "
                      << compiled_query_string;
          } else if (acc_state_promise_) {
            LOG(INFO)
            << "aborted liteserver query: " << reason.to_string() << " query: get account state, "
            << compiled_query_string;
          } else {
            LOG(INFO) << "aborted liteserver query: " << reason.to_string() << "QUERY: " << compiled_query_string;
          }
            ...
            td::actor::send_closure(cache_, &LiteServerCache::lookup, cache_key_,
                                    [SelfId = actor_id(this)](td::Result<td::BufferSlice> R) {
                                        if (R.is_error()) {
                                          ...
                                          td::actor::send_closure(SelfId, &LiteQuery::finish_query, R.move_as_ok(),
                                                                  true);
                                        }
                                    });
          } else {
        ...
        void LiteQuery::perform() {
          ...
          std::string query_compiled = "UNKNOWN";
                  ...
                  *query_obj_,
                  td::overloaded(
                          ...
                          [&](lite_api::liteServer_getBlock &q) {
                              ...
                              this->perform_getBlock(ton::create_block_id(q.id_));
                          },
                          ...
                          [&](lite_api::liteServer_getState &q) {
                              ...
                              this->perform_getState(ton::create_block_id(q.id_));
                          },
                          [&](lite_api::liteServer_getAccountState &q) {
                              ...
                              this->perform_getAccountState(ton::create_block_id(q.id_),
                                                            static_cast<WorkchainId>(q.account_->workchain_),
                                                            q.account_->id_, 0);
                          },
                          ...
                          [&](lite_api::liteServer_getTransactions &q) {
                              query_compiled =
                                      ...
                                      ")";
                              this->perform_getTransactions(static_cast<WorkchainId>(q.account_->workchain_),
                                                            q.account_->id_,
                                                            static_cast<LogicalTime>(q.lt_), q.hash_,
                                                            static_cast<unsigned>(q.count_));
                          },
                          [&](lite_api::liteServer_sendMessage &q) {

                              this->perform_sendMessage(std::move(q.body_));
                          },
                          [&](lite_api::liteServer_getShardInfo &q) {
                              ...
                              this->perform_getShardInfo(ton::create_block_id(q.id_),
                                                         ShardIdFull{q.workchain_, static_cast<ShardId>(q.shard_)},
                                                         q.exact_);
                          },
                          ...
                          [&](lite_api::liteServer_lookupBlockWithProof &q) {
                              ...
                              this->perform_lookupBlockWithProof(ton::create_block_id_simple(q.id_),
                                                                 ton::create_block_id(q.mc_block_id_), q.mode_, q.lt_,
                                                                 q.utime_);
                          },
                          [&](lite_api::liteServer_listBlockTransactions &q) {
                              ...
                              this->perform_listBlockTransactions(ton::create_block_id(q.id_), q.mode_, q.count_,
                                                                  (q.mode_ & 128) ? q.after_->account_
                                                                                  : td::Bits256::zero(),
                                                                  static_cast<LogicalTime>((q.mode_ & 128)
                                                                                           ? (q.after_->lt_) : 0));
                          },
                          ...
                          [&](lite_api::liteServer_getConfigParams &q) {
                              ...
                              this->perform_getConfigParams(ton::create_block_id(q.id_), (q.mode_ & 0xffff) | 0x10000,
                                                            q.param_list_);
                          },
                          ...
                          [&](lite_api::liteServer_getBlockProof &q) {
                              ...
                              this->perform_getBlockProof(ton::create_block_id(q.known_block_),
                                                          q.mode_ & 1 ? ton::create_block_id(q.target_block_)
                                                                      : ton::BlockIdExt{},
                                                          q.mode_);
                          },
                          ...
                          [&](lite_api::liteServer_runSmcMethod &q) {
                              ...
                              this->perform_runSmcMethod(ton::create_block_id(q.id_),
                                                         static_cast<WorkchainId>(q.account_->workchain_),
                          ...
                          [&](lite_api::liteServer_getLibrariesWithProof &q) {
                              ...
                              this->perform_getLibrariesWithProof(ton::create_block_id(q.id_), q.mode_,
                                                                  q.library_list_);
                          },
                          ...
                          [&](lite_api::liteServer_getOutMsgQueueSizes &q) {
                              ...
                              this->perform_getOutMsgQueueSizes(
                                      q.mode_ & 1 ? ShardIdFull(q.wc_, q.shard_) : td::optional<ShardIdFull>());
                          },
          ...
          compiled_query_string = std::move(query_compiled);
        }
        ...
        void LiteQuery::perform_getVersion() {
          ...
          td::int32 now = static_cast<td::int32>(std::time(nullptr));
          auto b = ton::create_serialize_tl_object<ton::lite_api::liteServer_version>(0, ls_version, ls_capabilities,
                                                                                      now);
          finish_query(std::move(b));
        }
        ...
        void LiteQuery::perform_getMasterchainInfo(int mode) {
          ...
          auto top_block_f = bool(acc_state_promise_)
          ...
          td::actor::send_closure_later(manager_, top_block_f,
                                        [Self = actor_id(this), return_state = bool(acc_state_promise_),
                                                mode](
                                                td::Result<std::pair<Ref<ton::validator::MasterchainState>, BlockIdExt>> res) {
                                            if (res.is_error()) {
        ...
        void
        LiteQuery::gotMasterchainInfoForAccountState(Ref<ton::validator::MasterchainState> mc_state, BlockIdExt blkid,
                                                     int mode) {
        ...
        void LiteQuery::continue_getMasterchainInfo(Ref<ton::validator::MasterchainState> mc_state, BlockIdExt blkid,
          ...
          auto zs_tl = create_tl_object<lite_api::tonNode_zeroStateIdExt>(zerostate_id.workchain,
        ...
        void LiteQuery::continue_getBlock(BlockIdExt blkid, Ref<ton::validator::BlockData> block) {
          ...
          auto b = ton::create_serialize_tl_object<ton::lite_api::liteServer_blockData>(
            ...
            td::actor::send_closure_later(manager_, &ValidatorManager::get_zero_state, blkid,
                                          [Self = actor_id(this), blkid](td::Result<td::BufferSlice> res) {
                                              if (res.is_error()) {
                                                ...
                                                td::actor::send_closure_later(Self, &LiteQuery::continue_getZeroState,
                                                                              blkid,
                                                                              res.move_as_ok());
                                              }
                                          });
          ...
          td::actor::send_closure_later(
                  ...
                  [Self = actor_id(this), data = std::move(data), manager = manager_, cache = cache_,
                      ...
                      if (res.is_error()) {
                        ...
                        td::actor::send_closure(Self, &LiteQuery::abort_query,
                                                res.move_as_error_prefix(
                                                        "cannot apply external message to current state : "s));
                      } else {
                        LOG(INFO) << "sending an external message to validator manager";
                        td::actor::send_closure_later(manager, &ValidatorManager::send_external_message,
                                                      res.move_as_ok());
        ...
        void LiteQuery::get_block_handle_checked(BlockIdExt blkid, td::Promise<ConstBlockHandle> promise) {
          td::actor::send_closure(manager_, &ValidatorManager::get_block_handle_for_litequery, blkid,
                                  std::move(promise));
        }
          ...
          td::actor::send_closure_later(
                  ...
                  [Self = actor_id(this), blkid](td::Result<Ref<BlockData>> res) {
                      if (res.is_error()) {
                        td::actor::send_closure(Self, &LiteQuery::abort_query,
                                                res.move_as_error_prefix(
                                                        "cannot load block "s + blkid.to_str() + " : "));
                      } else {
          ...
          td::actor::send_closure(
                  ...
                  [Self = actor_id(this), manager = manager_, blkid, mode](td::Result<td::BufferSlice> R) {
                      if (R.is_ok()) {
                        ...
                        proof.ensure();
                        td::actor::send_closure_later(Self, &LiteQuery::got_mc_block_proof, blkid, mode,
                                                      proof.move_as_ok());
                        return;
                      }
                      td::actor::send_closure_later(
                              ...
                              [Self, blkid, mode](td::Result<Ref<Proof>> res) {
                                  if (res.is_error()) {
                                    td::actor::send_closure(Self, &LiteQuery::abort_query,
                                                            res.move_as_error_prefix(
                                                                    "cannot load proof for "s + blkid.to_str() +
                                                                    " : "));
                                  } else {
                                    td::actor::send_closure_later(Self, &LiteQuery::got_mc_block_proof, blkid, mode,
                                                                  res.move_as_ok());
          ...
          td::actor::send_closure_later(
                  ...
                  [Self = actor_id(this), blkid](td::Result<Ref<ShardState>> res) {
                      if (res.is_error()) {
                        td::actor::send_closure(Self, &LiteQuery::abort_query,
                                                res.move_as_error_prefix(
                                                        "cannot load state for "s + blkid.to_str() + " : "));
                      } else {
        ...
        bool LiteQuery::request_proof_link(BlockIdExt blkid) {
          ...
          if (blkid.is_masterchain()) {
            td::actor::send_closure(
                    ...
                    [Self = actor_id(this), manager = manager_, blkid](td::Result<td::BufferSlice> R) {
                        if (R.is_ok()) {
                          auto proof = create_proof(blkid, R.move_as_ok());
                          proof.ensure();
                          td::actor::send_closure_later(Self, &LiteQuery::got_block_proof_link, blkid,
                                                        proof.move_as_ok());
                          return;
                        }
                        td::actor::send_closure_later(
                                ...
                                [Self, blkid](td::Result<Ref<ProofLink>> res) {
                                    if (res.is_error()) {
                                      td::actor::send_closure(
                                              Self, &LiteQuery::abort_query,
                                              res.move_as_error_prefix(
                                                      "cannot load proof link for "s + blkid.to_str() + " : "));
                                    } else {
                                      td::actor::send_closure_later(Self, &LiteQuery::got_block_proof_link, blkid,
                                                                    res.move_as_ok());
                                    }
            ...
            get_block_handle_checked(blkid,
                                     [=, manager = manager_, Self = actor_id(this)](td::Result<ConstBlockHandle> R) {
                                         if (R.is_error()) {
                                           td::actor::send_closure(Self, &LiteQuery::abort_query, R.move_as_error());
                                           return;
                                         }
                                         td::actor::send_closure_later(
                                                 manager, &ValidatorManager::get_block_proof_link_from_db,
                                                 R.move_as_ok(),
                                                 [=](td::Result<Ref<ProofLink>> res) {
                                                     if (res.is_error()) {
                                                       ...
                                                       td::actor::send_closure_later(Self,
                                                                                     &LiteQuery::got_block_proof_link,
                                                                                     blkid, res.move_as_ok());
                                                     }
                                                 });
                                     });
          }
                                       ...
                                       td::actor::send_closure_later(
                                               ...
                                               [=](td::Result<td::BufferSlice> res) {
                                                   if (res.is_error()) {
                                                     td::actor::send_closure(Self, &LiteQuery::abort_query,
                                                                             res.move_as_error_prefix(
                                                                                     "cannot load zerostate of "s +
                                                                                     blkid.to_str() + " : "));
                                                   } else {
                                                     td::actor::send_closure_later(Self, &LiteQuery::got_zero_state,
                                                                                   blkid, res.move_as_ok());
                                                   }
                                               });
                                   });
        ...
        void LiteQuery::perform_getAccountState(BlockIdExt blkid, WorkchainId workchain, StdSmcAddress addr, int mode) {
          LOG(DEBUG)
          << "started a getAccountState(" << blkid.to_str() << ", " << workchain << ", " << addr.to_hex() << ", "
          ...
          if (blkid.id.workchain != masterchainId) {
            ...
            td::actor::send_closure_later(
                    ...
                    [Self = actor_id(this)](
                            td::Result<std::pair<Ref<ton::validator::MasterchainState>, BlockIdExt>> res) -> void {
                        if (res.is_error()) {
                          td::actor::send_closure(Self, &LiteQuery::abort_query, res.move_as_error());
                        } else {
                          auto pair = res.move_as_ok();
                          td::actor::send_closure_later(Self, &LiteQuery::continue_getAccountState_0,
                                                        std::move(pair.first),
                                                        pair.second);
                        }
                    });
        ...
        void
        LiteQuery::perform_getLibrariesWithProof(BlockIdExt blkid, int mode, std::vector<td::Bits256> library_list) {
          LOG(INFO)
          << "started a getLibrariesWithProof(<list of " << library_list.size() << " parameters>) liteserver query";
          if (library_list.size() > 16) {
            LOG(INFO) << "too many libraries requested, returning only first 16";
            library_list.resize(16);
          }
          ...
          set_continuation(
                  [this, library_list, mode]() -> void { continue_getLibrariesWithProof(library_list, mode); });
          request_mc_block_data_state(blkid);
        }
        ...
        void LiteQuery::continue_getLibrariesWithProof(std::vector<td::Bits256> library_list, int mode) {
          ...
          auto b = ton::create_serialize_tl_object<ton::lite_api::liteServer_libraryResultWithProof>(
                  ton::create_tl_lite_block_id(base_blk_id_), mode, std::move(result),
                  state_proof_boc.move_as_ok(), data_proof_boc.move_as_ok());
          finish_query(std::move(b));
        }

        void LiteQuery::perform_getOneTransaction(BlockIdExt blkid, WorkchainId workchain, StdSmcAddress addr,
                                                  LogicalTime lt) {
          LOG(INFO)
          << "started a getOneTransaction(" << blkid.to_str() << ", " << workchain << ", " << addr.to_hex() << ","
          << lt << ") liteserver query";
          if (!blkid.is_valid_full()) {
        ...
        bool LiteQuery::make_shard_info_proof(Ref<vm::Cell> &proof, Ref<block::McShardHash> &info,
        ...
        bool LiteQuery::make_ancestor_block_proof(Ref<vm::Cell> &proof, Ref<vm::Cell> state_root,
          ...
          if (!mpb.extract_proof_to(proof)) {
            return fatal_error(
                    "error while constructing Merkle proof for old masterchain block "s + old_blkid.to_str());
          }
          return true;
        }
        ...
        void LiteQuery::finish_getAccountState(td::BufferSlice shard_proof) {
          ...
          vm::AugmentedDictionary accounts_dict{vm::load_cell_slice_ref(sstate.accounts), 256,
          ...
          auto b = ton::create_serialize_tl_object<ton::lite_api::liteServer_accountState>(
                  ton::create_tl_lite_block_id(base_blk_id_), ton::create_tl_lite_block_id(blk_id_),
...
// same as in lite-client/lite-client-common.cpp
        ...
        void LiteQuery::perform_getTransactions(WorkchainId workchain, StdSmcAddress addr, LogicalTime lt, Bits256 hash,
                                                unsigned count) {
          LOG(INFO)
          << "started a getTransactions(" << workchain << ", " << addr.to_hex() << ", " << lt << ", " << hash.to_hex()
  ...
  */
        ...
        void LiteQuery::continue_getTransactions(unsigned remaining, bool exact) {
          ...
          while (remaining && redo && trans_lt_ && block_.not_null()) {
            redo = false;
            if (!ton::shard_contains(block_->block_id().shard_full(),
                                     ton::extract_addr_prefix(acc_workchain_, acc_addr_))) {
            ...
            if (root.not_null()) {
              ...
              LOG(DEBUG)
              << "going to previous transaction with lt=" << trans.prev_trans_lt << " from current lt=" << trans_lt_;
              ...
              LOG(DEBUG)
              << "could not find transaction " << trans_lt_ << " of " << acc_workchain_ << ':' << acc_addr_.to_hex()
          ...
          ++pending_;
          LOG(DEBUG)
          << "sending get_block_by_lt_from_db() query to manager for " << acc_workchain_ << ":" << acc_addr_.to_hex()
          << " " << trans_lt_;
          td::actor::send_closure_later(
                  manager_, &ValidatorManager::get_block_by_lt_for_litequery,
                  ton::extract_addr_prefix(acc_workchain_, acc_addr_),
                  trans_lt_, [Self = actor_id(this), remaining, manager = manager_](td::Result<ConstBlockHandle> res) {
                      if (res.is_error()) {
                        td::actor::send_closure(Self, &LiteQuery::abort_getTransactions, res.move_as_error(),
                                                ton::BlockIdExt{});
                      } else {
                        auto handle = res.move_as_ok();
                        LOG(DEBUG) << "requesting data for block " << handle->id().to_str();
                        td::actor::send_closure_later(manager, &ValidatorManager::get_block_data_from_db, handle,
                                                      [Self, blkid = handle->id(), remaining](
                                                              td::Result<Ref<BlockData>> res) {
                                                          if (res.is_error()) {
                                                            td::actor::send_closure(Self,
                                                                                    &LiteQuery::abort_getTransactions,
                                                                                    res.move_as_error(), blkid);
                                                          } else {
                                                            td::actor::send_closure_later(Self,
                                                                                          &LiteQuery::continue_getTransactions_2,
                                                                                          blkid, res.move_as_ok(),
                                                                                          remaining);
                                                          }
                                                      });
        ...
        void LiteQuery::finish_getTransactions() {
          ...
          auto b = ton::create_serialize_tl_object<ton::lite_api::liteServer_transactionList>(std::move(a),
                                                                                              res.move_as_ok());
          finish_query(std::move(b));
        }
        ...
        void
        LiteQuery::load_prevKeyBlock(ton::BlockIdExt blkid, td::Promise<std::pair<BlockIdExt, Ref<BlockQ>>> promise) {
          td::actor::send_closure_later(manager_, &ton::validator::ValidatorManager::get_last_liteserver_state_block,
                                        [Self = actor_id(this), blkid, promise = std::move(promise)](
                                            ...
                                            td::actor::send_closure_later(Self, &LiteQuery::continue_loadPrevKeyBlock,
                                                                          blkid,
        ...
        void LiteQuery::continue_loadPrevKeyBlock(ton::BlockIdExt blkid,
          ...
          if (!base_blk_id_.is_masterchain_ext()) {
            promise.set_error(
                    td::Status::Error(PSTRING() << "the most recent masterchain block " << base_blk_id_.to_str()
                                                << " is invalid"));
            return;
          }
          ...
          if (state.is_null()) {
            promise.set_error(
                    td::Status::Error(
                            PSLICE() << "obtained no valid masterchain state for block " << base_blk_id_.to_str()));
            return;
          }
          if (blkid.seqno() > base_blk_id_.seqno()) {
            promise.set_error(td::Status::Error(PSLICE()
                                                << "client knows block " << blkid.to_str()
                                                << " newer than the reference masterchain block "
                                                << base_blk_id_.to_str()));
            return;
          }
          ...
          td::actor::send_closure_later(
                  ...
                  [Self = actor_id(this), key_blk_id, promise = std::move(promise)](
                          td::Result<Ref<BlockData>> res) mutable {
                      td::actor::send_closure_later(Self, &LiteQuery::finish_loadPrevKeyBlock, key_blk_id,
                                                    std::move(res),
                                                    std::move(promise));
                  });
        }
        ...
        void LiteQuery::finish_loadPrevKeyBlock(ton::BlockIdExt blkid, td::Result<Ref<BlockData>> res,
                                                td::Promise<std::pair<BlockIdExt, Ref<BlockQ>>> promise) {
          TRY_RESULT_PROMISE_PREFIX(promise, data, std::move(res),
                                    PSLICE() << "cannot load block " << blkid.to_str() << " : ");
        ...
        void LiteQuery::perform_getConfigParams(BlockIdExt blkid, int mode, std::vector<int> param_list) {
          LOG(INFO)
          << "started a getConfigParams(" << blkid.to_str() << ", " << mode << ", <list of " << param_list.size()
        ...
        void LiteQuery::perform_lookupBlockWithProof(BlockId blkid, BlockIdExt mc_blkid, int mode, LogicalTime lt,
          ...
          LOG(INFO)
          << "started a lookupBlockWithProof(" << blkid.to_str() << ", " << mc_blkid.to_str() << ", " << mode << ", "
          ...
          auto P = td::PromiseCreator::lambda(
                  [Self = actor_id(this), mc_blkid, manager = manager_, mode, pfx](td::Result<ConstBlockHandle> res) {
                      ...
                      if (!handle->inited_masterchain_ref_block()) {
                        td::actor::send_closure(Self, &LiteQuery::abort_query,
                                                td::Status::Error("block doesn't have masterchain ref"));
                        return;
                      }
                      if (handle->masterchain_ref_block() > mc_blkid.seqno()) {
                        td::actor::send_closure(Self, &LiteQuery::abort_query, td::Status::Error(
                                "specified mc block is older than block's masterchain ref"));
                        return;
                      }
                      LOG(DEBUG) << "requesting data for block " << handle->id().to_str();
                      td::actor::send_closure_later(manager, &ValidatorManager::get_block_data_from_db, handle,
                                                    [Self, mc_ref_blkid = handle->masterchain_ref_block(), mc_blkid, pfx, mode](
                                                            td::Result<Ref<BlockData>> res) {
                                                        if (res.is_error()) {
                                                          td::actor::send_closure(Self, &LiteQuery::abort_query,
                                                                                  res.move_as_error());
                                                          ...
                                                          td::actor::send_closure_later(Self,
                                                                                        &LiteQuery::continue_lookupBlockWithProof_getHeaderProof,
                                                                                        res.move_as_ok(), pfx,
                                                                                        mc_ref_blkid);
                                                        }
                                                    });
        ...
        void LiteQuery::continue_lookupBlockWithProof_getHeaderProof(Ref<ton::validator::BlockData> block,
          ...
          if (include_prev) {
            ...
            get_block_handle_checked(prev_blkid, [Self = actor_id(this), masterchain_ref_seqno, manager = manager_](
                    td::Result<ConstBlockHandle> R) mutable {
                if (R.is_error()) {
                  td::actor::send_closure(Self, &LiteQuery::abort_query, R.move_as_error());
                  return;
                }
        ...
        void LiteQuery::continue_lookupBlockWithProof_gotPrevBlockData(Ref<BlockData> prev_block,
          ...
          if (!blk_id_.is_masterchain()) {
            ...
            td::actor::send_closure_later(manager_, &ValidatorManager::get_block_by_seqno_from_db, pfx,
                                          masterchain_ref_seqno,
                                          [manager = manager_, Self = actor_id(this)](
                                                  td::Result<ConstBlockHandle> R) mutable {
                                              if (R.is_error()) {
                                                td::actor::send_closure(Self, &LiteQuery::abort_query,
                                                                        R.move_as_error());
                                              ...
                                              td::actor::send_closure(manager,
                                                                      &ValidatorManager::get_block_data_from_db,
                                                                      R.move_as_ok(),
                                                                      [Self](td::Result<Ref<BlockData>> res) mutable {
                                                                          if (res.is_error()) {
                                                                            td::actor::send_closure(Self,
                                                                                                    &LiteQuery::abort_query,
                                                                                                    res.move_as_error());
                                                                            return;
                                                                          }
                                                                          td::actor::send_closure(Self,
                                                                                                  &LiteQuery::continue_lookupBlockWithProof_buildProofLinks,
                                                                                                  res.move_as_ok(),
                                                                                                  std::vector<std::pair<BlockIdExt, td::Ref<vm::Cell>>>());
                                                                      });
                                          });
          } else {
          ...
          td::actor::send_closure_later(
                  ...
                  [Self = actor_id(this), result = std::move(result)](td::Result<Ref<BlockData>> R) mutable {
                      if (R.is_error()) {
                        ...
                        td::actor::send_closure_later(Self, &LiteQuery::continue_lookupBlockWithProof_buildProofLinks,
                                                      R.move_as_ok(),
                                                      std::move(result));
                      }
                  });
        ...
        void LiteQuery::continue_lookupBlockWithProof_getMcBlockPrev(
          ...
          for (auto &p: links) {
            ...
            links_res.push_back(
                    create_tl_object<lite_api::liteServer_shardBlockLink>(create_tl_lite_block_id(p.first),
          ...
          auto b = ton::create_serialize_tl_object<ton::lite_api::liteServer_lookupBlockResult>(
                  ...
                  mode_, ton::create_tl_lite_block_id(base_blk_id_alt_), std::move(mc_state_proof_buf),
                  std::move(client_mc_blk_proof_buf),
                        ...
                        td::actor::send_closure_later(manager, &ValidatorManager::get_block_data_from_db, handle,
                                                      [Self, blkid = handle->id(), mode](
                                                          ...
                                                          if (res.is_error()) {
                                                            ...
                                                            td::actor::send_closure_later(Self,
                                                                                          &LiteQuery::continue_getBlockHeader,
                                                                                          blkid, mode,
                                                                                          res.move_as_ok());
                                                          }
                                                      });
        ...
        void LiteQuery::perform_listBlockTransactions(BlockIdExt blkid, int mode, int count, Bits256 account,
                                                      LogicalTime lt) {
        ...
        static td::Result<tl_object_ptr<lite_api::liteServer_transactionMetadata>> get_in_msg_metadata(
          ...
          if (in_msg.is_null()) {
            return td::Status::Error(
                    PSTRING() << "no InMsg in InMsgDescr for message with hash " << in_msg_hash.to_hex());
          }
          ...
          if (msg_env.is_null()) {
            return td::Status::Error(
                    PSTRING() << "no MsgEnvelope in InMsg for message with hash " << in_msg_hash.to_hex());
          }
          block::tlb::MsgEnvelope::Record_std env;
          if (!block::tlb::unpack_cell(std::move(msg_env), env)) {
            return td::Status::Error(
                    PSTRING() << "failed to unpack MsgEnvelope for message with hash " << in_msg_hash.to_hex());
          }
          if (!env.metadata) {
            return nullptr;
          }
        ...
        void LiteQuery::finish_listBlockTransactions(int mode, int req_count) {
          LOG(INFO)
          << "completing a listBlockTransactions(" << base_blk_id_.to_str() << ", " << mode << ", " << req_count
          ...
          auto b = ton::create_serialize_tl_object<ton::lite_api::liteServer_blockTransactions>(
                  ton::create_tl_lite_block_id(base_blk_id_), req_count, !eof, std::move(result),
                  std::move(proof_data));
          finish_query(std::move(b));
        }
        ...
        void LiteQuery::finish_listBlockTransactionsExt(int mode, int req_count) {
          LOG(INFO)
          << "completing a listBlockTransactionsExt(" << base_blk_id_.to_str() << ", " << mode << ", " << req_count
          << ", " << acc_addr_.to_hex() << ", " << trans_lt_ << ") liteserver query";
          constexpr int max_answer_transactions = 256;
          CHECK(block_.not_null());
          auto block_root = block_->root_cell();
        ...
        void LiteQuery::perform_getBlockProof(ton::BlockIdExt from, ton::BlockIdExt to, int mode) {
          ...
          LOG(INFO)
          << "performing a getBlockProof(" << mode << ", " << from.to_str() << ", " << to.to_str() << ") query";
          ...
          if (mode & 1) {
            if (mode & 0x1000) {
              ...
              td::actor::send_closure_later(manager_, &ValidatorManager::get_shard_state_from_db_short, bblk,
                                            [Self = actor_id(this), from, to, bblk, mode](
                                                ...
                                                if (res.is_error()) {
                                                  ...
                                                  td::actor::send_closure_later(Self,
                                                                                &LiteQuery::continue_getBlockProof,
                                                                                from,
                                                                                to, mode, bblk,
                                                                                Ref<MasterchainStateQ>(
                                                                                        res.move_as_ok()));
                                                }
                                            });
            } else {
              td::actor::send_closure_later(
                      manager_, &ton::validator::ValidatorManager::get_last_liteserver_state_block,
                      [Self = actor_id(this), from, to, mode](
                              td::Result<std::pair<Ref<MasterchainState>, BlockIdExt>> res) {
                          if (res.is_error()) {
                            td::actor::send_closure(Self, &LiteQuery::abort_query, res.move_as_error());
                          } else {
                            auto pair = res.move_as_ok();
                            td::actor::send_closure_later(Self, &LiteQuery::continue_getBlockProof, from, to, mode,
                                                          pair.second,
            ...
            td::actor::send_closure_later(
                    ...
                    [Self = actor_id(this), from, mode](td::Result<std::pair<Ref<MasterchainState>, BlockIdExt>> res) {
                        if (res.is_error()) {
                          ...
                          auto pair = res.move_as_ok();
                          td::actor::send_closure_later(Self, &LiteQuery::continue_getBlockProof, from, pair.second,
                                                        mode,
            ...
            td::actor::send_closure_later(manager_, &ton::validator::ValidatorManager::get_shard_client_state, false,
                                          [Self = actor_id(this), from, mode](td::Result<BlockIdExt> res) {
                                              if (res.is_error()) {
                                                ...
                                                td::actor::send_closure_later(Self, &LiteQuery::perform_getBlockProof,
                                                                              from,
        ...
        void LiteQuery::continue_getBlockProof(ton::BlockIdExt from, ton::BlockIdExt to, int mode, BlockIdExt baseblk,
          ...
          if (!base_blk_id_.is_masterchain_ext()) {
            fatal_error("reference masterchain block "s + base_blk_id_.to_str() +
                        " for constructing a proof chain is invalid");
            return;
          }
          if (!(mode & 1)) {
        ...
        bool LiteQuery::construct_proof_chain(ton::BlockIdExt id) {
          ...
          if (chain_->to.seqno() == id.seqno()) {
            return fatal_error(
                    "cannot have two different masterchain blocks "s + chain_->to.to_str() + " and " + id.to_str() +
                    " of the same height");
          }
          if (chain_->to.seqno() < id.seqno()) {
          ...
          if (prev_key_blk.seqno() > id.seqno() || (prev_key_blk.seqno() == id.seqno() && prev_key_blk != id)) {
            return fatal_error(
                    "block "s + prev_key_blk.to_str() + " cannot be the previous key block for " + id.to_str());
          }
          ...
          if (next_key_blk.is_valid()) {
            if (!(next_key_blk.is_masterchain_ext() && next_key_blk.seqno() > id.seqno())) {
              return fatal_error(
                      "block "s + next_key_blk.to_str() + " cannot be the next key block after " + id.to_str());
            }
...
// adjust dest_proof and is_key of the last link of existing proof
        ...
        bool LiteQuery::construct_proof_link_forward_cont(ton::BlockIdExt cur, ton::BlockIdExt next) {
          ...
          try {
            ...
            if (cur.seqno()) {
              ...
              auto res = vm::StaticBagOfCellsDbLazy::create(td::BufferSliceBlobView::create(std::move(buffer_)),
                                                            options);
              if (res.is_error()) {
            ...
            if (nodes.empty()) {
              return fatal_error(
                      PSTRING() << "cannot compute validator set for block " << next.to_str() << " with utime "
            ...
            if (vset.is_null()) {
              return fatal_error(
                      PSTRING() << "cannot create validator set for block " << next.to_str() << " with utime "
                                << info.gen_utime << " and cc_seqno " << info.gen_catchain_seqno
                                << " starting from previous key block " << cur.to_str());
            }
            ...
            if (vset_hash != info.gen_validator_list_hash_short) {
              return fatal_error(PSTRING() << "computed validator set for block " << next.to_str() << " with utime "
                                           << info.gen_utime << " and cc_seqno " << info.gen_catchain_seqno
                                           << " starting from previous key block " << cur.to_str() << " has hash "
                                           << vset_hash
    ...
    */
            ...
            if (!(cur_mpb.extract_proof_to(link.proof) && next_mpb.extract_proof_to(link.dest_proof))) {
              return fatal_error(
                      "error constructing Merkle proof for forward proof link from "s + cur.to_str() + " to " +
                      next.to_str());
            }
            ...
            return fatal_error(
                    "virtualization error during construction of forward proof link from "s + cur.to_str() + " to " +
                    next.to_str());
          }
        ...
        bool LiteQuery::finish_proof_chain(ton::BlockIdExt id) {
          CHECK(chain_);
          LOG(INFO)
          << "finish constructing block proof chain from " << chain_->from.to_str() << " to " << chain_->to.to_str()
          ...
          try {
            ...
            for (auto &link: chain_->links) {
              ...
              if (link.to.seqno()) {
                ...
                if (res.is_error()) {
                  return fatal_error(
                          "error while serializing destination block Merkle proof in block proof link from "s +
              ...
              if (link.is_fwd) {
                ...
                a.push_back(create_tl_object<lite_api::liteServer_blockLinkForward>(
                        ...
                        create_tl_object<lite_api::liteServer_signatureSet>(link.validator_set_hash, link.cc_seqno,
                                                                            std::move(b))));
              } else {
            ...
            auto c = ton::create_serialize_tl_object<ton::lite_api::liteServer_partialBlockProof>(
                    chain_->complete, ton::create_tl_lite_block_id(chain_->from),
                    ton::create_tl_lite_block_id(chain_->to),
                    std::move(a));
        ...
        void LiteQuery::continue_getValidatorStats(int mode, int limit, Bits256 start_after, UnixTime min_utime) {
          ...
          auto b = ton::create_serialize_tl_object<ton::lite_api::liteServer_validatorStats>(
                  mode & 0xff, ton::create_tl_lite_block_id(base_blk_id_), count, complete, res1.move_as_ok(),
                  res2.move_as_ok());
          finish_query(std::move(b));
        }
        ...
        void LiteQuery::perform_getShardBlockProof(BlockIdExt blkid) {
          ...
          get_block_handle_checked(blkid, [manager = manager_, Self = actor_id(this)](td::Result<ConstBlockHandle> R) {
              ...
              td::actor::send_closure_later(
                      manager, &ValidatorManager::get_block_by_seqno_for_litequery, pfx,
                      ...
                      [Self, manager](td::Result<ConstBlockHandle> R) {
                          if (R.is_error()) {
                            ...
                            td::actor::send_closure_later(
                                    ...
                                    [Self](td::Result<Ref<BlockData>> R) {
                                        if (R.is_error()) {
                                          td::actor::send_closure(Self, &LiteQuery::abort_query, R.move_as_error());
                                        } else {
                                          td::actor::send_closure_later(Self, &LiteQuery::continue_getShardBlockProof,
                                                                        R.move_as_ok(),
        ...
        void LiteQuery::continue_getShardBlockProof(Ref<BlockData> cur_block,
          ...
          if (prev_id == blk_id_) {
            ...
            LOG(INFO) << "getShardBlockProof() query completed";
            auto b = create_serialize_tl_object<lite_api::liteServer_shardBlockProof>(
                    create_tl_lite_block_id(base_blk_id_),
                    std::move(links));
            finish_query(std::move(b));
            return;
          }
          ...
          td::actor::send_closure_later(
                  ...
                  [Self = actor_id(this), shard](td::Result<std::pair<Ref<MasterchainState>, BlockIdExt>> res) {
                      if (res.is_error()) {
                        ...
                        td::actor::send_closure_later(Self, &LiteQuery::continue_getOutMsgQueueSizes, shard,
                                                      res.ok().first);
                      }
                  });
        }
        ...
        void LiteQuery::finish_getBlockOutMsgQueueSize() {
          ...
          if (!tlb::unpack_cell(state_root, sstate) ||
              !tlb::unpack_cell(sstate.out_msg_queue_info, out_msg_queue_info)) {
        ...
        void
        LiteQuery::perform_nonfinal_getCandidate(td::Bits256 source, BlockIdExt blkid, td::Bits256 collated_data_hash) {
          LOG(INFO) << "started a nonfinal.getCandidate liteserver query";
          td::actor::send_closure_later(
                  manager_, &ValidatorManager::get_block_candidate_for_litequery, PublicKey{pubkeys::Ed25519{source}},
                  blkid, collated_data_hash,
                        ...
                        td::actor::send_closure_later(
                                ...
                                create_serialize_tl_object<lite_api::liteServer_nonfinal_candidate>(
                                        create_tl_object<lite_api::liteServer_nonfinal_candidateId>(
                                                create_tl_lite_block_id(cand.id), cand.pubkey.as_bits256(),
                                                cand.collated_file_hash),
          ...
          td::actor::send_closure(
                  ...
                  [Self = actor_id(this)](td::Result<tl_object_ptr<lite_api::liteServer_nonfinal_validatorGroups>> R) {
                      if (R.is_error()) {
                        ...
                        td::actor::send_closure_later(Self, &LiteQuery::finish_query,
                                                      serialize_tl_object(R.move_as_ok(), true),
                                                      false);
                      }
                  });
        }
