...
class ArchiveSlice : public td::actor::Actor {
 public:
  ArchiveSlice(td::uint32 archive_id, bool key_blocks_only, bool temp, bool finalized, td::uint32 shard_split_depth, std::string db_root,
               td::actor::ActorId<ArchiveLru> archive_lru, DbStatistics statistics = {}, bool read_only=false);
